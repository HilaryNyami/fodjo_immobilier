    ...
    <div class="row justify-content-center my-4">
        <div class="col-lg-8 col-md-10">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="../controller/H_updateAcheterController.php?H_idEmploye=<?= $_SESSION['H_idEmploye'] ?>&Y_idAcheteur=<?= $_SESSION['H_idAcheteur'] ?>">
                        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="card-footer d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary bg-primary-green border-0" name="Modifier" value="">Modifier</button>
                        </div>
                    </form>
                </div>
            </div>
