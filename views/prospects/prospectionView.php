                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-4 border-bottom border-border">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <button type="button" class="btn btn-sm bg-primary text-primary-foreground hover:bg-primary/90 transition-colors duration-200" onclick="exportToPDF()">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content bg-card border-border">
                ...
                <div class="modal-footer bg-muted border-border">
                    ...
                    <button type="button" class="btn bg-primary text-primary-foreground" onclick="exportDescentesToPDF()">
