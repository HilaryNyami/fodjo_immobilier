...
if (isset($_POST['Enregistrer'])){
    ...
    if ($paye < $total) {
        ...
        header('Location: /FodjoManage/'.encodeUrl(['page'=>'Y_acheteurDetail' , 'H_idEmploye'=>$_SESSION['H_idEmploye'], 'Y_idAcheteur'=>$Y_idAcheteur]));
        exit;
    } else {
...
if (isset($_POST['numeroCNI'])) {
    ...
    header('Location: /FodjoManage/'.encodeUrl(['page'=>'Y_acheteurDetail' , 'H_idEmploye'=>$_SESSION['H_idEmploye'], 'Y_idAcheteur'=>$Y_idAcheteur, 'voirPiece'=>1]));
    exit;
