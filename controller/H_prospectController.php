                            ...
                            if(preg_match($H_regexTelephone, $H_telephoneProspect)) // mb_strlen($H_telephoneProspect) >= 9 && mb_strlen($H_telephoneProspect) <= 18
                                {
                                    ...
                                    $H_executeInsertProspect = F_executeRequeteSql($H_insertProspect, $H_tableauParametres); //ajoute le nouveau Employe pour la descente
                                     ...
                                     if($H_emailProspect !== null)
                                    {
                                        if(filter_var($H_emailProspect, FILTER_VALIDATE_EMAIL))
                                        {
                                            //$H_emailOK = $H_emailProspect;
                                            $H_insertEmailProspect = 'UPDATE prospects SET emailProspect = ? WHERE idProspect = ?';
                                            $H_executeInsertEmailProspect = F_executeRequeteSql($H_insertEmailProspect, [$H_emailProspect, $H_newIdProspect]);
                                        }
                                        else
                                        {
